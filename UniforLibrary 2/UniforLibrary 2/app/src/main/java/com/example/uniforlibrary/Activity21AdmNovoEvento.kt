...
class Activity21AdmNovoEvento : AppCompatActivity() {
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity21_adm_novo_evento)

        findViewById<Button>(R.id.btn_voltar_activity21_adm_novo_evento).setOnClickListener {
            finish()
        }


        var spinner_sala = findViewById<Spinner>(R.id.spinner_sala_activity21_adm_novo_evento)
        var spinner_horario = findViewById<Spinner>(R.id.spinner_horario_activity21_adm_novo_evento)
        ...
        findViewById<Button>(R.id.btn_criar_activity21_adm_novo_evento).setOnClickListener {
            var nome_evento = findViewById<EditText>(R.id.eT_nomeEvento_activity21_adm_novo_evento).text.toString()
            var data_evento = findViewById<EditText>(R.id.eT_data_activity21_adm_novo_evento).text.toString()
            var descricao = findViewById<EditText>(R.id.eT_descricao_activity21_adm_novo_evento).text.toString()

...
/**
 * Loads [MainFragment16].
 */
class Activity26AdmEditar : FragmentActivity() {

    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity26_adm_editar)

        findViewById<Button>(R.id.btn_voltar_activity26_adm_editar).setOnClickListener {
            finish()
        }

        findViewById<LinearLayout>(R.id.linearLayout_livros_activity26_adm_editar).setOnClickListener {
            Intent(this, Activity27AdmEdicao::class.java).also{
                startActivity(it)
            }
        }

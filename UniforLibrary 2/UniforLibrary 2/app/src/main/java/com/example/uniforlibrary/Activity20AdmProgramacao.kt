...
class Activity20AdmProgramacao : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity20_adm_programacao)

        findViewById<Button>(R.id.btn_voltar_activity20_adm_programacao).setOnClickListener {
            finish()
        }

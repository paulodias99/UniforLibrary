...
/**
 * Loads [MainFragment15].
 */
class Activity29AdmHistorico : FragmentActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity29_adm_historico)

        findViewById<Button>(R.id.btn_voltar_activity29_adm_historico).setOnClickListener {
            finish()
        }

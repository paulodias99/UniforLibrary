...
class Activity13UserProgramacao : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity13_user_programacao)

        findViewById<Button>(R.id.btn_voltar_activity13_user_programacao).setOnClickListener {
            finish()
        }

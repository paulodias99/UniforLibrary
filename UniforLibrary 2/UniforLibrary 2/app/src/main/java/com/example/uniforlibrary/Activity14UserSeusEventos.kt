...
class Activity14UserSeusEventos : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity14_user_seus_eventos)

        findViewById<Button>(R.id.btn_voltar_activity14_user_seus_eventos).setOnClickListener {
            finish()
        }

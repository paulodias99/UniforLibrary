...
class Activity11UserEventos : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity11_user_eventos)

        findViewById<Button>(R.id.btn_programacao_activity11_user_eventos).setOnClickListener {
            Intent(this, Activity13UserProgramacao::class.java).also {
                startActivity(it)
            }
        }


        findViewById<Button>(R.id.btn_criar_activity11_user_eventos).setOnClickListener {
            Intent(this, Activity12UserNovoEvento::class.java).also {
                startActivity(it)
            }
        }


        findViewById<Button>(R.id.btn_seusEventos_activity11_user_eventos).setOnClickListener {
            Intent(this, Activity14UserSeusEventos::class.java).also {
                startActivity(it)
            }
        }

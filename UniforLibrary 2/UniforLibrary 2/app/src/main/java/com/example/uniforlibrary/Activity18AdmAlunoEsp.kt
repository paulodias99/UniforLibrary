...
/**
 * Loads [MainFragment18].
 */
class Activity18AdmAlunoEsp : FragmentActivity() {

    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity18_adm_aluno_esp)

        findViewById<Button>(R.id.btn_voltar_activity18_adm_aluno_esp).setOnClickListener {
            finish()
        }
